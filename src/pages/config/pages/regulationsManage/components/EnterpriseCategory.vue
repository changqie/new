      ...
      <el-form :inline="true" :model="standardForm"  ref="ruleForm" class="label-input-form">
        ...
        <el-form-item class="serch-form-item btn-box">
          <el-button
            ...
            class="searchAngNewBtn"
            @click="classBatchDel"
            v-btn-permission="'NLP3P6APLJ'">删除</el-button>
        </el-form-item>
        </div>
      </el-form>
    </div>
    ...
    <el-drawer
      ...
      <div class="demo-drawer__content" v-if="this.oprState === 1 || this.oprState === 2">
        ...
        <div class="demo-drawer__footer">
          <el-button size="mini" @click="closeModal('enterpriseModelAdd')">取 消</el-button>
          <el-button size="mini" type="primary" @click="saveEnterprise('enterpriseModelAdd')">提交</el-button>
        </div>
      </div>
      <div class="demo-drawer__content" v-else>
        <!-- <div class="check-item-row">
          <div class="check-item-col1">
            ...
            <div class="check-item-value">{{enterpriseModelAdd.dicTypeName}}</div>
          </div>
          <div class="check-item-col1">
            <div class="check-item-label">排序号：</div>
            <div class="check-item-value">{{enterpriseModelAdd.showIndex}}</div>
          </div>
        </div>
        <div class="check-item-row">
          <div class="check-item-col2">
              <div class="check-item-label">描述：</div>
              <div class="check-item-value">{{enterpriseModelAdd.describes}}</div>
          </div>
          <div class="check-item-col2">
