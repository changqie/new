      ...
      <el-form :inline="true" :model="standardForm"  ref="ruleForm" class="label-input-form">
        ...
        <el-form-item class="serch-form-item btn-box">
          <el-button
            ...
            class="searchAngNewBtn"
            @click="classBatchDel"
            v-btn-permission="'DMQ3BBGW6Y'">删除</el-button>
        </el-form-item>
        </div>
      </el-form>
    </div>
    ...
    <el-drawer
      ...
      <div class="demo-drawer__content" v-if="this.oprState === 1 || this.oprState === 2">
        ...
        <div class="demo-drawer__footer">
          <el-button size="mini" @click="closeModal('classificationModelAdd')">取 消</el-button>
          <el-button size="mini" type="primary" @click="saveClass('classificationModelAdd')">提交</el-button>
        </div>
      </div>
